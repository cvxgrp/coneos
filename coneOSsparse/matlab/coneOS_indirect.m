function [x, y, status] = coneOS_indirect(A, b, c, cone, params)			    
%coneOS_INDIRECT Operator-splitting method for solving cone problems (indirect)
%
...
error ('coneOS_indirect mexFunction not found') ;
